...
import { uploadRecipePhoto, type RecipePhoto } from "@/features/recipes/photos";
import type { CreateRecipeInput, RecipeVisibility, RecipeIngredient } from "@/features/recipes/types";
...
export default function CreateRecipeScreen() {
  ...
  async function handleSubmit() {
    ...
    try {
      // Build recipe input with canonical fields if confirmed
      ...
      <ScrollView style={styles.container}>
        ...
        >
          <Text style={styles.submitButtonText}>
            {isUploadingPhoto ? "Uploading Photos..." : isSubmitting ? "Creating..." : "Create Recipe"}
          </Text>
        </Pressable>
      </ScrollView>
    </>

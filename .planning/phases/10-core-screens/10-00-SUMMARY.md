...
plan: "00"
subsystem: testing
tags: [jest, typescript, tdd, pure-functions, recipe-card, cooking-mode]
...
affects:
  - "10-01 (RecipeCard component imports recipeCardUtils)"
  - "10-05 (Cooking mode screen imports cookingModeUtils)"

# Tech tracking
tech-stack:
  added: []
  patterns:
    - "Extract pure logic into side-effect-free utility modules for Jest node-environment testability"
    - "TDD red-green cycle: commit failing tests, then commit passing implementation separately"
...
patterns-established:
  - "Utility pattern: pure TypeScript functions in *Utils.ts files alongside their component/feature, no React imports"
  - "TDD pattern: commit RED (failing test file) before GREEN (implementation) — two commits per TDD task"

requirements-completed: [SCREEN-02, SCREEN-04a]
